# -*- coding: utf-8 -*-
"""
Created on Sun Sep  1 20:01:59 2019 @author: AKHIL Poojary
"""
...
date = parser.parse('2017,December,23')
date
date.strftime('%A')
...
np.datetime64('2017-12-23 12:00', 'ns')  # NanoSecond
...
pd.date_range('2017-01-01',periods=3, freq='A-APR')
